...
public class HkBannerServiceImpl implements HkBannerService {
    ...
    @Override
    public int insertHkBanner(HkBanner hkBanner) {
        hkBanner.setImage("**.jpg");
        hkBanner.setSort(1);
        hkBanner.setStatus(2);
        hkBanner.setCreatedTime(new Date());
        hkBanner.setUpdatedBy("admin");
        hkBanner.setCreatedBy("admin");
        hkBanner.setUpdatedTime(new Date());
        return this.hkBannerDao.addList(hkBanner);
    }
    /**
     * @description:  根据id删除
     * @param: [hkBannerRequest]
    ...
    @Override
    public int deleteHkBanner(int id) {
        return this.hkBannerDao.deleteHkBanner(id);
    }
    /**
     * @description:  修改
     * @param: [hkBannerRequest]
     ...
     */
    @Override
    public int updateHkBanner(HkBanner hkBanner) {
        return this.hkBannerDao.updateHkBanner(hkBanner);
    }
     ...
     */
    @Override
    public HkBanner findHkBannerById(int id) {
        return this.hkBannerDao.findHkBannerById(id);
    }
